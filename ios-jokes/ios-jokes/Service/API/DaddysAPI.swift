...
public class DaddysAPI: JokersAPI {
   
    private var urlComponents: URLComponents {
        var components = URLComponents()
        components.scheme = "https"
        components.host = "dad-jokes.p.rapidapi.com"
        components.path = "/random/joke"
        return components
    }
    ...
    private var request: URLRequest {
        ...
        request.setValue("dad-jokes.p.rapidapi.com", forHTTPHeaderField: "x-rapidapi-host")
        request.setValue("d3c97d05eemsh279809fe9d69034p1ed0aejsn440014f3237e", forHTTPHeaderField: "x-rapidapi-key")
        return request
    }
...
// MARK: - Body
struct Body: Codable {
    let id, setup, punchline, type: String
    let likes: [JSONAny]
    let author: Author
    let approved: Bool
    let date: Int
    ...
    enum CodingKeys: String, CodingKey {
        case id = "_id"
        case setup, punchline, type, likes, author, approved, date
        case nsfw = "NSFW"
    }
}
